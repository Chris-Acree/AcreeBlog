    ...
    copy: {
      build: {
        files: [
          ...
          { expand: true, src: ['css/.css'], dest: 'wwwroot/lib/css/', filter: 'isFile', flatten: true },          
          ...
          { expand: true, src: ['css/.csss'], dest: 'wwwroot/lib/css/', filter: 'isFile', flatten: true },
          { expand: true, src: ['assets/js/*.js'], dest: 'wwwroot/lib/js/', filter: 'isFile', flatten: true },
          { expand: true, src: ['assets/lib/tinymce/tinymce.min.js'], dest: 'wwwroot/lib/js/', filter: 'isFile', flatten: true }
        ]
      }
    }
  });
